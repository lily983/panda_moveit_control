...
int main(int argc, char** argv) {
    ...
    geometry_msgs::Pose test_class_pose;
    test_class_pose.orientation.x = 0.939;
    test_class_pose.orientation.y = 0.063;
    test_class_pose.orientation.z = 0.3;
    test_class_pose.orientation.w = -0.156;
    test_class_pose.position.x = 0.3;
    test_class_pose.position.y = -0.224;
    test_class_pose.position.z = 0.501;
    panda_arm.MoveToPoseTarget(test_class_pose);
