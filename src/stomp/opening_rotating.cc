                                ...
                                panda_moveit_control::ExecuteStompTraj::Response &res)
{
    ...
    traj_stomp_to_pregrasp = panda_arm_.PlanningToPoseTarget(grasp_pose_, stomp_first_point.positions);
    ...
    traj_start_to_pregrasp = panda_arm_.PlanningToJointTarget(traj_stomp_to_pregrasp.joint_trajectory.points.at(0).positions);
